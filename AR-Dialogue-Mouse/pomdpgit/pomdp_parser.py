...
class Model(object):
  def __init__(self, pomdp_file='/home/chelsea/dialogue_eye_gaze_ws/src/move_robot_gaze/scripts/pomdp/appl/src/model_update_2.pomdp', parsing_print_flag=True):

    self.filename = pomdp_file
